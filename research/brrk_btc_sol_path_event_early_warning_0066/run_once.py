...
RUN_INTERFACE_BLOB = "7b1f7f489fe3b11812f3e48c3922ef9021b86daa"
RESULT_SCHEMA_BLOB = "dfe76fa4291924786596ed0ed54e088628299257"
PINNED_BLOBS = {
    "research/brrk_btc_sol_path_event_early_warning_0066/RUN_INTERFACE.json": RUN_INTERFACE_BLOB,
    "research/brrk_btc_sol_path_event_early_warning_0066/RESULT_SCHEMA.json": RESULT_SCHEMA_BLOB,
    "research/brrk_btc_sol_path_event_early_warning_0066/PREREGISTRATION.json": "8a7949cb84c46b802252de8c39f67936cf491901",
    "research/brrk_btc_sol_path_event_early_warning_0066/DATASET_DECLARATION.json": "daed821114325422dbfdaf6ce3979b4a529565b2",
    "research/brrk_btc_sol_path_event_early_warning_0066/IMPLEMENTATION_CONTRACT.json": "82ff75368cdd52fb9776316f5def76d655b66552",
...
def _invalid_result(stage: str, exc: Exception, counts: dict[str, int], loader_calls: int, engine_calls: int) -> tuple[dict, dict]:
    primary = {
        "schema_version": 1,
        "research_id": RID,
        ...
        "predictor_tracks": {},
        "predictive_winners": [],
        "predictor_simultaneous_bootstrap": {"block_length": 60, "replicates": 4000, "seed": 660066, "q95": None},
        "benchmark_0064_same_window": {},
        "controllers": {},
        "economic_simultaneous_bootstrap": {"block_length": 60, "replicates": 4000, "seed": 660066, "q95": None},
        "PBO_CSCV": {"status": "NOT_EVALUATED"},
        "controller_error": {"failure_stage": stage, "error_type": type(exc).__name__, "error_message": str(exc)},
...
def evaluate(boundary_sha: str) -> dict:
    ...
    if marker.get("research_id") != RID or marker.get("attempt_number") != 1 or marker.get("boundary_merge_sha") != boundary_sha:
