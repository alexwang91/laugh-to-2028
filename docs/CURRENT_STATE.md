...
Stablecoin liquidity research     STABLECOIN-LIQUIDITY-0001 / RUN INTERFACE FROZEN_NOT_EXECUTED / VALIDATION DATA BOUND / NO STAGE-1 RESULT
...
MERGE THE STABLECOIN RUN-INTERFACE PR ONLY AFTER GOVERNANCE + NO-DRIFT + P3.2 PARITY/GOLDEN + PHASE-6 SAFETY CHECKS PASS
...
RUN INTERFACE STABLECOIN-LIQUIDITY-0001-RUN-INTERFACE-V1 IS FROZEN_NOT_EXECUTED; DO NOT MODIFY ITS ECONOMIC/STATISTICAL DEGREES OF FREEDOM AFTER MERGE
...
NEXT STABLECOIN PR MAY ONLY ARM THE FROZEN ONE-SHOT STAGE-1 EXECUTION: CLAIM CREATE-ONLY RUN MARKER BEFORE RESULT-BEARING COMPUTATION, VERIFY STABLECOIN RAW HASH, FREEZE/PERSIST BINANCE PRICE PAYLOAD PROVENANCE, RECONFIRM CANONICAL P3.2 PARITY, THEN EXECUTE EXACTLY THE FROZEN INTERFACE ONCE
DO NOT FIT RIDGE, CONSTRUCT REAL OOS PREDICTIONS, RUN STAGE-1 OR RELEASE A RESULT IN THE RUN-INTERFACE PR ITSELF
AFTER THE RUN INTERFACE IS MERGED, RUN EXACTLY ONE STAGE-1 VARIANT UNDER [STABLECOIN_STAGE1_EXECUTE_V1]; NO RESCUE TUNING, NO AUTOMATIC RETRY AFTER RESULT-BEARING OUTPUT, AND NO REPEATED EVALUATION
